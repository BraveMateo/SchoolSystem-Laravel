                ...
                <div class="flex items-center justify-between border border-gray-200 -mb-px">
                    ...
                    <div class="w-1/4 text-right text-gray-600 py-2 px-4 font-medium">
                        <?php if($attendance->attendence_status): ?>
                            <span class="text-xs text-white bg-green-500 px-2 py-1 rounded">Present</span>
                        <?php else: ?>
                            <span class="text-xs text-white bg-red-500 px-2 py-1 rounded">Absent</span>
                        <?php endif; ?>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div><?php /**PATH D:\XAMPP\htdocs\CollegeManagementSystem-Laravel\resources\views/dashboard/student.blade.php ENDPATH**/ ?>