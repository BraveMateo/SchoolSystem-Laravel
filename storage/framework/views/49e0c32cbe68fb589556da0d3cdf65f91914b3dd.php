    ...
    <div class="roles-permissions">
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex flex-wrap items-center">
                <a href="<?php echo e(route('assignrole.create')); ?>" class="bg-green-500 text-white text-sm uppercase py-2 px-4 flex items-center rounded">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\CollegeManagementSystem-Laravel\resources\views/backend/assignrole/index.blade.php ENDPATH**/ ?>