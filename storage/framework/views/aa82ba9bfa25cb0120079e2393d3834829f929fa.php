            ...
            <div class="flex flex-wrap items-center">
                <?php $__currentLoopData = $teacher->classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="w-full sm:w-1/2 text-center border border-gray-400 rounded">
                        ...
                        <a href="<?php echo e(route('teacher.attendance.create',$class->id)); ?>" class="bg-green-600 inline-block mb-4 text-xs text-white uppercase font-semibold px-4 py-2 border border-gray-200 rounded">Manage Attendence</a>
                    </div>
...
</div> <!-- ./END TEACHER --><?php /**PATH D:\XAMPP\htdocs\CollegeManagementSystem-Laravel\resources\views/dashboard/teacher.blade.php ENDPATH**/ ?>