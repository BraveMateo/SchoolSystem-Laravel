    ...
    <div class="roles-permissions">
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex flex-wrap items-center">
                <a href="<?php echo e(route('teacher.create')); ?>" class="bg-green-500 text-white text-sm uppercase py-2 px-4 flex items-center rounded">
            ...
            <?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex flex-wrap items-center text-gray-700 border-t-2 border-l-4 border-r-4 border-gray-300">
                    ...
                    <div class="w-2/12 flex items-center justify-end px-3">
                        ...
                        <a href="<?php echo e(route('teacher.destroy', $teacher->id)); ?>" data-url="<?php echo e(route('teacher.destroy', $teacher->id)); ?>" class="deletebtn ml-1 bg-red-600 block p-1 border border-red-600 rounded-sm">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\CollegeManagementSystem-Laravel\resources\views/backend/teachers/index.blade.php ENDPATH**/ ?>