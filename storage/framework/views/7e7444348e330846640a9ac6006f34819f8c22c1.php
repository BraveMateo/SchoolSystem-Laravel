    ...
    <div class="roles-permissions">
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex flex-wrap items-center">
                <a href="<?php echo e(route('classes.create')); ?>" class="bg-green-500 text-white text-sm uppercase py-2 px-4 flex items-center rounded">
            ...
            <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex flex-wrap items-center text-gray-700 border-t-2 border-l-4 border-r-4 border-gray-300">
                    ...
                    <div class="w-2/12 flex items-center justify-end px-3">
                        <a href="<?php echo e(route('classes.edit',$class->id)); ?>" title="Edit">
                        ...
                        <a href="<?php echo e(route('class.assign.subject',$class->id)); ?>" class="ml-1 bg-blue-600 block p-1 border border-blue-600 rounded-sm" title="Assign Subject">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\codeastro\Laravel\SchoolSystem-Laravel\resources\views/backend/classes/index.blade.php ENDPATH**/ ?>