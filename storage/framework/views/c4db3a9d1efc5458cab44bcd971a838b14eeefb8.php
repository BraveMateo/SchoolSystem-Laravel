    ...
    <div class="profile">
        <div class="sm:flex sm:items-center sm:justify-between mb-6">
            ...
            <div class="flex flex-wrap items-center">
                <a href="<?php echo e(route('profile.edit')); ?>" class="bg-blue-600 text-white text-sm uppercase py-2 px-4 flex items-center rounded">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\codeastro\Laravel\SchoolSystem-Laravel\resources\views/profile/index.blade.php ENDPATH**/ ?>